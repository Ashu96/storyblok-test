...
import StaffMemberCard from '../src/components/StaffMemberCard/StaffMemberCard'

const stories = storiesOf('Components | StaffMemberCard', module)
...
stories.add(
	'StaffMemberCard',
	() => (
		<StaffMemberCard {...props} title={text('title', props.title)}>
			{text('Text', 'Book a demo')}
		</StaffMemberCard>
	),
	{ notes: { markdown: '##StaffMemberCard\n For page heading' } }
)
