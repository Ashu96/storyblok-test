...
import FeaturePricingCard from '../src/components/FeaturePricingCard/FeaturePricingCard'

const stories = storiesOf('Components | FeaturePricingCard', module)
...
stories.add(
	'FeaturePricingCard',
	() => (
		<FeaturePricingCard {...props} title={text('title', props.title)}>
			{text('Text', 'Book a demo')}
		</FeaturePricingCard>
	),
	{ notes: { markdown: '##FeaturePricingCard\n For page heading' } }
)
