...
import CollateralCard from '../src/components/CollateralCard/CollateralCard'

const stories = storiesOf('Components | CollateralCard', module)
...
stories.add(
	'CollateralCard',
	() => (
		<CollateralCard {...props} title={text('title', props.title)}>
			{text('Text', 'Book a demo')}
		</CollateralCard>
	),
	{ notes: { markdown: '##CollateralCard\n For page heading' } }
)
