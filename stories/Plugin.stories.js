...
import Plugin from '../src/components/Plugin/Plugin'

const stories = storiesOf('Components | Plugin', module)
...
stories.add(
	'Plugin',
	() => (
		<Plugin {...props} title={text('title', props.title)}>
			{text('Text', 'Book a demo')}
		</Plugin>
	),
	{ notes: { markdown: '##Plugin\n For page heading' } }
)
