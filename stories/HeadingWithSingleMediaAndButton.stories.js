...
import HeadingWithSingleMediaAndButton from '../src/components/HeadingWithSingleMediaAndButton/HeadingWithSingleMediaAndButton'

const stories = storiesOf('Components | HeadingWithSingleMediaAndButton', module)
...
stories.add(
	'HeadingWithSingleMediaAndButton',
	() => (
		<HeadingWithSingleMediaAndButton {...props} title={text('title', props.title)}>
			{text('Text', 'Book a demo')}
		</HeadingWithSingleMediaAndButton>
	),
	{ notes: { markdown: '##HeadingWithSingleMediaAndButton\n For page heading' } }
)
