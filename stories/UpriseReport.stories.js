...
import UpriseReport from '../src/components/UpriseReport/UpriseReport'

const stories = storiesOf('Components | UpriseReport', module)
...
stories.add(
	'UpriseReport',
	() => (
		<UpriseReport {...props} title={text('title', props.title)}>
			{text('Text', 'Book a demo')}
		</UpriseReport>
	),
	{ notes: { markdown: '##UpriseReport\n For page heading' } }
)
