...
import TrainingCard from '../src/components/TrainingCard/TrainingCard'

const stories = storiesOf('Components | TrainingCard', module)
...
stories.add(
	'TrainingCard',
	() => (
		<TrainingCard {...props} title={text('title', props.title)}>
			{text('Text', 'Book a demo')}
		</TrainingCard>
	),
	{ notes: { markdown: '##TrainingCard\n For page heading' } }
)
