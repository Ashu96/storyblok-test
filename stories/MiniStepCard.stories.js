...
import MiniStepCard from '../src/components/MiniStepCard/MiniStepCard'

const stories = storiesOf('Components | MiniStepCard', module)
...
stories.add(
	'MiniStepCard',
	() => (
		<MiniStepCard {...props} title={text('title', props.title)}>
			{text('Text', 'Book a demo')}
		</MiniStepCard>
	),
	{ notes: { markdown: '##MiniStepCard\n For page heading' } }
)
