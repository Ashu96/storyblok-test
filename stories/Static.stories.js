...
import Static from '../src/components/Static/Static'

const stories = storiesOf('Components | Static', module)
...
stories.add(
	'Static',
	() => (
		<Static {...props} title={text('title', props.title)}>
			{text('Text', 'Book a demo')}
		</Static>
	),
	{ notes: { markdown: '##Static\n For page heading' } }
)
