...
import PricingGate from '../src/components/PricingGate/PricingGate'

const stories = storiesOf('Components | PricingGate', module)
...
stories.add(
	'PricingGate',
	() => (
		<PricingGate {...props} title={text('title', props.title)}>
			{text('Text', 'Book a demo')}
		</PricingGate>
	),
	{ notes: { markdown: '##PricingGate\n For page heading' } }
)
