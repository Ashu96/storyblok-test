...
import CalendarCard from '../src/components/CalendarCard/CalendarCard'

const stories = storiesOf('Components | CalendarCard', module)
...
stories.add(
	'CalendarCard',
	() => (
		<CalendarCard {...props} title={text('title', props.title)}>
			{text('Text', 'Book a demo')}
		</CalendarCard>
	),
	{ notes: { markdown: '##CalendarCard\n For page heading' } }
)
